...
table <- read.csv("tables/de_summary.csv") %>%
  rename(
...
table <- read.csv("tables/GSEA_results.csv")  %>%
...
```{r dim_plots, results="asis"}

a_vals <- unlist(strsplit(reductions,";")
b_vals <- unlist(strsplit(legends,";")
